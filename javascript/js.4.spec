...
MultiLineCommentChars ::
	((SourceCharacter but not *)* *+ (SourceCharacter but not (/ or *)))* ((SourceCharacter but not *)* **)?
...
EscapeSequence ::
	...
	SourceCharacter but not (SingleEscapeCharacter or DecimalDigit or x or u or LineTerminator)
